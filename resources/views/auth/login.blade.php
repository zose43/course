...
@section('content')
    ...
    <x-forms.auth-form title="Вход в аккаунт" action="{{ route('login.handle') }}">
        @csrf
        <x-forms.text-input
            name="email"
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5">
                <div class="text-xxs md:text-xs"><a class="text-white hover:text-white/70 font-bold" href="{{ route('forgot') }}">Забыли пароль?</a>
                </div>
