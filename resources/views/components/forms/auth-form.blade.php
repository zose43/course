<div class="max-w-[640px] mt-12 mx-auto p-6 xs:p-8 md:p-12 2xl:p-16 rounded-[20px] bg-purple">
    ...
    <ul class="space-y-3 my-3">
        <li>
            <a class="relative flex items-center h-14 px-12 rounded-lg border border-[#A07BF0] bg-white/20 hover:bg-white/20 active:bg-white/10 active:translate-y-0.5"
               href="#">
                <svg class="shrink-0 absolute left-4 w-5 sm:w-6 h-5 sm:h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="space-y-3 mt-5">
        <div class="text-xxs md:text-xs"><a class="text-white hover:text-white/70 font-bold" href="lost-password.html">Забыли пароль?</a></div>
        <div class="text-xxs md:text-xs"><a class="text-white hover:text-white/70 font-bold" href="register.html">Регистрация</a></div>
    </div>
    <ul class="flex flex-col md:flex-row justify-between gap-3 md:gap-4 mt-14 md:mt-20">
        <li>
            <a class="inline-block text-white hover:text-white/70 text-xxs md:text-xs font-medium" href="#" rel="noopener" target="_blank">Пользовательское
                соглашение</a>
        </li>
        ...
        <li>
            <a class="inline-block text-white hover:text-white/70 text-xxs md:text-xs font-medium" href="#" rel="noopener" target="_blank">Политика
