...
@section('content')
            ...
            <div class="grow flex flex-col lg:py-8">
                ...
                <ul class="flex items-center gap-2 mt-4">
                    <li class="text-[#FFC107]">
                        <svg class="w-4 md:w-6 h-4 md:h-6" fill="currentColor" viewBox="0 0 52 52"
                ...
                <form method="POST" action="{{ route('cart.add', $product) }}"
                    ...
                    <div class="flex flex-wrap items-center gap-3 xs:gap-4">
                        ...
                        <button class="!px-6 xs:!px-8 btn btn-pink" type="submit">Добавить в корзину</button>
                        <a class="w-[68px] !px-0 btn btn-purple" href="#" title="В избранное">
    ...
    <section class="mt-12 xl:mt-16 pt-8 lg:pt-12 border-t border-white/10">
        @include('product.shared.description')
    </section>
