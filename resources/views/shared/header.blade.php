                        ...
                        >
                            ...
                            <div class="mt-6">
                                <form action="{{ route('log-out') }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button href="#" class="inline-flex items-center text-body hover:text-pink">
                ...
                @elseguest()
                    <a href="{{ route('login') }}" class="profile hidden xs:flex items-center">
                        <svg class="profile-icon w-8 h-8 text-purple" xmlns="http://www.w3.org/2000/svg"
                             aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 32 32">
                            <defs/>
                            <path
