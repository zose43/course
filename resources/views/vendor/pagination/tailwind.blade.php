    ...
    <nav>
        <ul class="flex flex-wrap items-center justify-center gap-3">
            ...
            @if (!$paginator->onFirstPage())
                <li>
                    <a class="block p-3 text-white hover:text-pink text-sm font-black leading-none" href="{{ $paginator->previousPageUrl() }}" rel="prev"
            ...
            @if ($paginator->hasMorePages())
                <li>
                    <a class="block p-3 text-white hover:text-pink text-sm font-black leading-none" href="{{ $paginator->nextPageUrl() }}" rel="next"
